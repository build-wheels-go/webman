...
* Fixed X-Forwarded-For unsafe handling of CVE-2020-28483 [#2844](https://webman/framework/gin/pull/2844), closed issue [#2862](https://webman/framework/gin/issues/2862).
* Tree: updated the code logic for `latestNode` [#2897](https://webman/framework/gin/pull/2897), closed issue [#2894](https://webman/framework/gin/issues/2894) [#2878](https://webman/framework/gin/issues/2878).
* Tree: fixed the misplacement of adding slashes [#2847](https://webman/framework/gin/pull/2847), closed issue [#2843](https://webman/framework/gin/issues/2843).
* Tree: fixed tsr with mixed static and wildcard paths [#2924](https://webman/framework/gin/pull/2924), closed issue [#2918](https://webman/framework/gin/issues/2918).

### ENHANCEMENTS

* TrustedProxies: make it backward-compatible [#2887](https://webman/framework/gin/pull/2887), closed issue [#2819](https://webman/framework/gin/issues/2819).
* TrustedPlatform: provide custom options for another CDN services [#2906](https://webman/framework/gin/pull/2906).

### DOCS

* NoMethod: added usage annotation ([#2832](https://webman/framework/gin/pull/2832#issuecomment-929954463)).
...
* fix level 1 router match [#2767](https://webman/framework/gin/issues/2767), [#2796](https://webman/framework/gin/issues/2796)

## Gin v1.7.2

### BUGFIXES

* Fix conflict between param and exact path [#2706](https://webman/framework/gin/issues/2706). Close issue [#2682](https://webman/framework/gin/issues/2682) [#2696](https://webman/framework/gin/issues/2696).

## Gin v1.7.1

### BUGFIXES

* fix: data race with trustedCIDRs from [#2674](https://webman/framework/gin/issues/2674)([#2675](https://webman/framework/gin/pull/2675))

## Gin v1.7.0

### BUGFIXES

* fix compile error from [#2572](https://webman/framework/gin/pull/2572) ([#2600](https://webman/framework/gin/pull/2600))
* fix: print headers without Authorization header on broken pipe ([#2528](https://webman/framework/gin/pull/2528))
* fix(tree): reassign fullpath when register new node ([#2366](https://webman/framework/gin/pull/2366))

### ENHANCEMENTS

* Support params and exact routes without creating conflicts ([#2663](https://webman/framework/gin/pull/2663))
* chore: improve render string performance ([#2365](https://webman/framework/gin/pull/2365))
* Sync route tree to httprouter latest code ([#2368](https://webman/framework/gin/pull/2368))
* chore: rename getQueryCache/getFormCache to initQueryCache/initFormCa ([#2375](https://webman/framework/gin/pull/2375))
* chore(performance): improve countParams ([#2378](https://webman/framework/gin/pull/2378))
* Remove some functions that have the same effect as the bytes package ([#2387](https://webman/framework/gin/pull/2387))
* update:SetMode function ([#2321](https://webman/framework/gin/pull/2321))
* remove a unused type SecureJSONPrefix ([#2391](https://webman/framework/gin/pull/2391))
* Add a redirect sample for POST method ([#2389](https://webman/framework/gin/pull/2389))
* Add CustomRecovery builtin middleware ([#2322](https://webman/framework/gin/pull/2322))
* binding: avoid 2038 problem on 32-bit architectures ([#2450](https://webman/framework/gin/pull/2450))
* Prevent panic in Context.GetQuery() when there is no Request ([#2412](https://webman/framework/gin/pull/2412))
* Add GetUint and GetUint64 method on gin.context ([#2487](https://webman/framework/gin/pull/2487))
* update content-disposition header to MIME-style ([#2512](https://webman/framework/gin/pull/2512))
* reduce allocs and improve the render `WriteString` ([#2508](https://webman/framework/gin/pull/2508))
* implement ".Unwrap() error" on Error type ([#2525](https://webman/framework/gin/pull/2525)) ([#2526](https://github.com/gin-gonic/gin/pull/2526))
